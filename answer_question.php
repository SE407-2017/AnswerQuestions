...
<body>
    ...
    <div style="position: absolute; left:33%; top:10%;">
        <form action="huida.php" method="post"  enctype="multipart/form-data">
			...
			?>" size="49">
            <br>
            <textarea rows="10" cols="50" readonly><?php echo $_GET["content"];?></textarea>
            <br>
			...
			<?php
				...
				for ($x=1;$x<=$rnum;$x++)
				{
					...
					echo "<br>";
					echo "<textarea rows='10' cols='50' readonly>".$rowx["reply_text_content"]."</textarea>";
					echo "<br>";
					if ($r_url!="")
					{
            ...
            <textarea rows="10" cols="50" placeholder="在这里输入你要回复的内容（不多于500字）" maxlength="500" name="textarea" ></textarea>
            <br>
